...
//
// svc-healthcheck client HTTP transport
//
// Command:
...
// Client lists the svc-healthcheck service endpoint HTTP clients.
type Client struct {
...
// NewClient instantiates HTTP clients for all the svc-healthcheck service
// servers.
func NewClient(
	scheme string,
	host string,
...
// Check returns an endpoint that makes HTTP requests to the svc-healthcheck
...
func (c *Client) Check() goa.Endpoint {
	...
	return func(ctx context.Context, v any) (any, error) {
		...
		if err != nil {
			return nil, goahttp.ErrRequestError("svc-healthcheck", "check", err)
		}
